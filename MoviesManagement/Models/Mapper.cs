...
namespace MoviesManagement.Models
{
    ...
    {
        //////////////////////////////////ACTIVITY ROLE//////////////////////////////////
        public ItemModel MapEntityToModelItem(ActivityRole entity)
        {
        ...
        public EmployeeModel MapEntityToModel(Employee entity)
        {
            EmployeeModel model = new EmployeeModel()
            {
                ...
                IsDeleted = entity.IsDeleted,
                EmployeeProjections = entity.Activities?.ConvertAll(MapEntityToModel)
            };
        ...
        public EmployeeProjectionModel MapEntityToModel(ProjectionActivity entity)
        {
            EmployeeProjectionModel model = new EmployeeProjectionModel()
            {
                ...
                ActivityRole = MapEntityToModelItem(entity.ActivityRole),
                Projection = MapEntityToModelItem(entity.Projection)
            };
            return model;
        }
        ...
        public Employee MapModelToEntity(EmployeeModel model)
        {
            Employee entity = new Employee()
            {
                ...
                IsDeleted = model.IsDeleted,
                Activities = model.EmployeeProjections?.ConvertAll(MapModelToEntity)
            };
        ...
        //////////////////////////////////////PROJECTION////////////////////////////
        public ItemModel MapEntityToModelItem(Projection entity)
        {
            ItemModel model = new ItemModel()
            {
                Id = entity.ProjectionId,
                IsDeleted = entity.IsDeleted,
                Name = entity.Start.ToString()
            };
            return model;
        }
